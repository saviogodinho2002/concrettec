      ...
      <v-form @submit.prevent="submit" autocomplete="off">
        <v-card class="!tw-shadow-sm !tw-border !tw-border-gray-100 rounded-xl">
          <v-card-text>
            ...
            <v-row>
              <v-col cols="12" md="6" class="tw-mt-3">
                <v-text-field
                  v-model="form.name"
                  label="Nome da Obra"
                ...
                <v-row>
                  ...
                  <v-col cols="4">
                    <v-btn
                      ...
                      :disabled="!canSearch"
                      class="!tw-font-medium tw-flex tw-items-center tw-gap-2 !tw-h-full tw-w-full"
                    >
                      <Icon class="!tw-text-white" icon="solar:minimalistic-magnifer-bold-duotone" width="22" height="22" />
                      Buscar CEP
                    </v-btn>
                  </v-col>
                  ...
                  <v-col cols="12">
                    ...
                    >
                      <Icon class="!tw-text-white" icon="solar:map-point-search-bold-duotone" width="22" height="22" />
                      Buscar no Mapa
                    </v-btn>
                    <div class="tw-bg-yellow-50 tw-p-3 tw-border tw-border-yellow-200 tw-rounded-md mt-5">
              ...
              <v-col cols="12" md="6">
                ...
                <div id="map" class="tw-h-[415px] tw-w-full tw-rounded-lg tw-border tw-border-gray-200"></div>
            ...
            <div class="tw-flex tw-justify-between tw-items-center tw-mb-3">
              ...
              >
                <div class="tw-flex tw-gap-3 tw-items-center">
                  ...
                  {{ construction ? 'Atualizar' : 'Criar' }} Obra
                </div>
              </v-btn>
            </div>
