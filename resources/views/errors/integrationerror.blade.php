            ...
            @if(isset($content['request']))
                <tr>
                    <td>
                        ...
                        <p><strong>Method:</strong> {{ $content['request']['method'] ?? 'N/A' }}</p>
                        <p><strong>URL:</strong> {{ $content['request']['url'] ?? 'N/A' }}</p>
                        <p><strong>Headers:</strong>
                        <pre>{{ json_encode($content['request']['headers'] ?? [], JSON_PRETTY_PRINT) }}</pre>
                        </p>
                        <p><strong>Body:</strong>
                        <pre>{{ json_encode($content['request']['body'] ?? [], JSON_PRETTY_PRINT) }}</pre>
                        </p>
                    </td>
                </tr>
            @endif
            @if(isset($content['user']))
                <tr>
                    <td>
                        ...
                        <p><strong>Nome:</strong> {{ $content['user']["name"] }}</p>


                        <p><strong>Roles:</strong>

                            {{ json_encode($content['user']["roles"] ?? [], JSON_PRETTY_PRINT) }}
                        </p>
